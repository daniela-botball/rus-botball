...
#define RELEASING_POSITION -450
#define SCORING_POSITION 200
#define DOUBLER_POSITION -1650
...
void drop_three_hangers() {
	...
	press_a_to_continue();
	create_drive_distance(25, 15, FORWARDS);
	press_a_to_continue();
...
void pick_up_first_doubler() {
	...
	press_a_to_continue();
	create_drive_distance(4, 15, FORWARDS);
	press_a_to_continue();
	create_spin_degrees(90, 33, RIGHT);
	press_a_to_continue();
